...
<!--webbot bot="Navigation" endspan -->
    ...
    <tr> <td colspan=3 class="ms-titleareaframe"> <div class="ms-titleareaframe"> <table width=100% border=0 class="ms-titleareaframe" cellpadding=0 cellspacing=0> <tr> <td style="padding-bottom: 0px"> <table style="padding-top: 0px;padding-left: 2px" cellpadding=0 cellspacing=0 border=0> <tr> <td align=center nowrap style="padding-top: 4px" width="108" height="46"> <img ID=onetidtpweb1 src="/_layouts/images/dlicon.gif" alt="Icon" height="49" width="49"> </td> <td><IMG SRC="/_layouts/images/blank.gif" width=22 height=1 alt=""></td> <td nowrap width="100%" style="padding-top: 0px"> <table cellpadding=0 cellspacing=0> <tr> <td nowrap class="ms-titlearea"> <SharePoint:ProjectProperty Property="Title" runat="server"/> </td> </tr> <tr> <td ID=onetidPageTitle class="ms-pagetitle"><table cellpadding=0 cellspacing=0 border=0 width=100%><tr><td class="ms-pagetitle"><SharePoint:ListProperty Property="Title" runat="server"/></td></tr><tr><td><table class="ms-titlearea" cellpadding=0 cellspacing=0 border=0 width=100%><tr><td width=20><img src="/_layouts/images/ofolder.gif" alt="Folder"></td><td><SharePoint:ListProperty Property="RelativeFolderPath" runat="server"/></td></tr></table></td></tr></table><!-- --></td> </tr> </table> </td> <td align=right valign=top> <table cellpadding=0 cellspacing=0 height=100%> <tr> <SharePoint:ViewSearchForm ID="L_SearchView" Prompt="Search this view" Go="Go"  runat="server"/> </tr> <tr style="padding-right:1px"><td colspan=5 nowrap style="padding-bottom: 3px; padding-top: 1px; vertical-align: bottom" align=right class="ms-vb"> <span class='ms-SPLink'> <span class='ms-HoverCellInActive' onmouseover="this.className='ms-HoverCellActive'"; onmouseout="this.className='ms-HoverCellInActive'">  </span> </span>  &nbsp; </td></tr> </table> </td> </tr> </table> <table cellpadding=0 cellspacing=0 border=0 width=100%> <tr> <td class="ms-titlearealine" height=1 colspan=5><IMG SRC="/_layouts/images/blank.gif" width=1 height=1 alt=""></td> </tr> </table> </td> </tr> </table> </div> </td> </tr>
    <!-- Navigation -->
