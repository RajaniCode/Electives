...
@gacutil -if .\PipelinesAndSchemas\bin\Deployment\Aggregator.PipelinesAndSchemas.dll
@gacutil -if .\Aggregate\bin\Deployment\Aggregator.Aggregate.dll
...
@btstask AddResource -ApplicationName:%ApplicationName% -Type:System.BizTalk:BizTalkAssembly -Source:".\PipelinesAndSchemas\bin\Deployment\Aggregator.PipelinesAndSchemas.dll" -Overwrite -Destination:"C:\AggregatorSample\Aggregator.PipelinesAndSchemas.dll"
@btstask AddResource -ApplicationName:%ApplicationName% -Type:System.BizTalk:BizTalkAssembly -Source:".\Aggregate\bin\Deployment\Aggregator.Aggregate.dll" -Overwrite -Destination:"C:\AggregatorSample\Aggregator.Aggregate.dll"
