...
REM ### Post import part of the script called for a new application.
if "%BTAD_ChangeRequestAction%"=="Create" (
  if "%BTAD_InstallMode%"=="Import" (
	...
	echo %DATE% %TIME% "Post import part of the script called for a new application" >> %LogFile%
    )
  )
)

REM ### Post import part of the script called for an existing application
if "%BTAD_ChangeRequestAction%"=="Update" (
  if "%BTAD_InstallMode%"=="Import" (
    if "%BTAD_HostClass%"=="ConfigurationDb" (
	REM ### Remove the following line, and add your code here 
	echo %DATE% %TIME% "Post import part of the script called for an existing application" >> %LogFile%
    )
  )
)

REM ### Post install part of the script called for a new or existing application
if "%BTAD_ChangeRequestAction%"=="Update" (
  if "%BTAD_InstallMode%"=="Install" (
    if "%BTAD_HostClass%"=="BizTalkHostInstance" (
	REM ### Remove the following line, and add your code here 
	echo %DATE% %TIME% "Post install part of the script called for an existing application" >> %LogFile%
    )
  )
)

REM ### Post uninstall part of the script called for an existing application
if "%BTAD_ChangeRequestAction%"=="Delete" (
  if "%BTAD_InstallMode%"=="Uninstall" (
    if "%BTAD_HostClass%"=="BizTalkHostInstance" (
	REM ### Remove the following line, and add your code here 
	echo %DATE% %TIME% "Post uninstall part of the script called for an existing application" >> %LogFile%
    )
  )
)
