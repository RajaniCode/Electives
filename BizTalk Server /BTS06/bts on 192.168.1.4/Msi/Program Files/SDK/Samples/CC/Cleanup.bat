...
@SET AssemblyName=PipelineComponentSample
...
@BTSTask RemoveApp -ApplicationName:CustomComponentApplication > Undeploy.log

@ECHO.
@ECHO Removing the pipeline component from the pipeline directory...
@gacutil -uf FixMsg
@DEL /F /Q "..\..\..\..\Pipeline Components\FixMsg.dll"
