...
@gacutil -if .\PipelinesAndSchemas\bin\Deployment\CMP.PipelinesAndSchemas.dll
@gacutil -if .\Orchestration\bin\Deployment\CMP.Orchestration.dll
...
@btstask AddResource -ApplicationName:%ApplicationName% -Type:System.BizTalk:BizTalkAssembly -Source:".\PipelinesAndSchemas\bin\Deployment\CMP.PipelinesAndSchemas.dll" -Overwrite -Destination:"C:\CMPSample\PipelinesAndSchemas.dll"
@btstask AddResource -ApplicationName:%ApplicationName% -Type:System.BizTalk:BizTalkAssembly -Source:".\Orchestration\bin\Deployment\CMP.Orchestration.dll" -Overwrite -Destination:"C:\CMPSample\CMP.Orchestration.dll"
