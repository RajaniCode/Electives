...
namespace Microsoft.BizTalk.SDKSamples.Adapters
{
    ...
    /// </summary>
    internal abstract class DotNetFileCommonProperties : ConfigProperties
    {
        ...
        public DotNetFileCommonProperties ()
        {
        }
    ...
    /// </summary>
    internal class DotNetFileReceiveProperties : DotNetFileCommonProperties
    {
		// Handler properties
        ...
        public DotNetFileReceiveProperties () : base()
        {
            // establish defaults
	...
	/// </summary>
    internal class DotNetFileTransmitProperties : DotNetFileCommonProperties
    {
		// Handler properties
