...
@SET ReceivePortName=HTTPRequestResponsePort
@SET VirtualDirectoryName=RequestResponse
...
@BTSTask RemoveApp -ApplicationName:HttpRequestResponseApplication > Undeploy.log

@ECHO.
@ECHO Removing the IIS vDirs...

@CScript /NoLogo ..\..\RemoveIISVDir.vbs %VirtualDirectoryName%
@CScript /NoLogo ..\..\RemoveIISVDir.vbs HTTPRequestResponseSample
