...
namespace Microsoft.Samples.BizTalk.MedicalClaimsProcessingandTestingPolicies.RulesForMedicalClaims
{
	...
	class RulesCreator
	{
		...
		public void CreateRuleSet() 
		{
			...
			ClassBinding dateClass = new ClassBinding(typeof(System.DateTime));
			...
			// Member Bindings to bind to the properties and members in the ClaimResults and System.DateTime class that need to be used in rule defintion
			
			ClassMemberBinding today = new ClassMemberBinding("Today",dateClass);
