'--------------------------------------------------------------------------
'
' WMI script to rename a biztalk server
'
'--------------------------------------------------------------------------
...
Sub RenameBizTalkServer()
	...
	strQuery = "SELECT * FROM MSBTS_GroupSetting"
	...
	If objInstSet.Count > 0 then
		...
		Next
	Else
		WScript.Echo "No Group was found."
	End If
...
Sub PrintUsage()
	WScript.Echo "Usage:" + Chr(10) + Chr(10) + _
				 "cscript RenameBizTalkServer.vbs <new group name>" + Chr(10) + Chr(10)
End Sub
