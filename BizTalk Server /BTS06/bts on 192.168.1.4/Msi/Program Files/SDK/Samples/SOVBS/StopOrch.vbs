...
Sub StopOrch()
	...
	'Check if orchestration is to be unenlisted
	...
	If InstSet.Count > 0 then
		For Each Inst in InstSet
			Inst.Stop AutoDisableReceiveLocation, AutoSuspendOrchestrationInstance
			If Err <> 0	Then
				PrintWMIErrorThenExit Err.Description, Err.Number
			End If
...
Sub PrintUsage()
	WScript.Echo "Usage:" + Chr(10) + Chr(10) + _
		     ...
		     "[Unenlist]              = An optional parameter to indicate that the orchestration should be unenlisted." + _
