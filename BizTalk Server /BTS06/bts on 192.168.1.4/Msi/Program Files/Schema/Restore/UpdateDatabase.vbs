...
oldDBName = node.getAttribute("oldDBName")
	...
	' We also need to update the adm_OtherDatabases table as this is used to manage QFE installments
...
if ( (newHWSAdminDBServer <> "") AND (newHWSAdminDBName <> "") ) then
	wscript.echo "Info: Attempting to connect to server """ & newHWSAdminDBServer & """, database """ & newHWSAdminDBName & """..."
