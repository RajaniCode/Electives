...
// MessageText:
//
//  The Application Users account for this application is not valid. 
//  If it is a local account check that this account exists on the server. 
//  If it is a domain account contact your domain administrator. 
//  Enable the application when the account is valid.
//  You can ignore this message if you are not going to use this application on this computer.
//  %r
...
// MessageText:
//
//  The Application Admin account for this application is not valid.
//  If it is a local account check that this account exists on the server.
//  If it is a domain account contact your domain administrator.
//  Enable the application when the account is valid.
//  You can ignore this message if you are not going to use this application on this computer.
...
// *** NEW EVENT RANGE (2) ***
//
// MessageId: SSO_WARN_CHECK_GROUP
//
// MessageText:
//
...
//  Error Code: %4
//
#define SSO_WARN_CHECK_GROUP             0x80002B00L
...
//
// MessageId: SSO_WARN_PS_ADAPTER_REPORTED_FAILURE
//
// MessageText:
//
//  The password sync adapter reported a failure while attempting to change the external password. The external password was not updated in the SSO database.%r
//  Tracking ID: %1%r
//  Adapter: %2%r
//  External Account: %3%r
//  Error Message: %4%r
//  Error Code: %5
//
#define SSO_WARN_PS_ADAPTER_REPORTED_FAILURE 0x80002B23L

//
// MessageId: SSO_WARN_DEFAULT_FLAGS
//
// MessageText:
//
//  Some flags have been ignored and were changed to their default values.%r
//  Tracking ID: %1%r
//  Application Name: %2%r
//  Requested Flags: %3%r
//  Changed Flags: %4%r
//  Actual Flags: %5
//
#define SSO_WARN_DEFAULT_FLAGS           0x80002B24L

//
// MessageId: SSO_WARN_EXISTING_MAPPING_WINDOWS
//
// MessageText:
//
//  A mapping could not be created because a mapping already exists for the specified Windows account.%r
//  Tracking ID: %1%r
//  Application Name: %2%r
//  Windows Account: %3
//
#define SSO_WARN_EXISTING_MAPPING_WINDOWS 0x80002B25L

//
// MessageId: SSO_WARN_EXISTING_MAPPING_EXTERNAL
//
// MessageText:
//
//  A mapping could not be created because a mapping already exists for the specified external account.%r
//  Tracking ID: %1%r
//  Application Name: %2%r
//  External Account: %3
//
#define SSO_WARN_EXISTING_MAPPING_EXTERNAL 0x80002B26L

//
// MessageId: SSO_ERROR_SSOSQL_FAILED
//
// MessageText:
//
//  Could not create SSOSQL. To fix the problem, reinstall SSO or try 'regasm SSOSQL.dll' from a Visual Studio command prompt.%r
//  Error Code: %1
//
#define SSO_ERROR_SSOSQL_FAILED          0xC0002B27L

//
// MessageId: SSO_ERROR_SSOCSTX_FAILED
//
// MessageText:
//
//  Could not create SSOCSTX. To fix the problem, reinstall SSO or install SSOCSTX.dll into a COM+ library application.%r
//  Additional Data: %1%r
//  Error Code: %2
//
#define SSO_ERROR_SSOCSTX_FAILED         0xC0002B28L

//
// MessageId: SSO_ERROR_DTC_FAILED
//
// MessageText:
//
//  Could not get MSDTC. SSO requires MSDTC for correct operation. Check that MSDTC is correctly installed and configured.%r
//  Error Code: %1
//
#define SSO_ERROR_DTC_FAILED             0xC0002B29L

//
// MessageId: SSO_INFO_LINE
//
// MessageText:
//
//  SSO: %1%r
//
#define SSO_INFO_LINE                    0x40002B2AL

//
// MessageId: SSO_WARN_SSO_ADMIN_NOT_GROUP
//
// MessageText:
//
//  The SSO Admin account contains one or more individual (not group) accounts.
//  If these individual accounts are deleted from Active Directory or the local computer they must be promptly removed from the SSO system or they could become a security risk.%r
//  SSO Admin account: %1%r
//  Individual accounts: %2
//
#define SSO_WARN_SSO_ADMIN_NOT_GROUP     0x80002B2BL

//
// MessageId: SSO_WARN_SSO_AFF_ADMIN_NOT_GROUP
//
// MessageText:
//
//  The SSO Affiliate Admin account contains one or more individual (not group) accounts.
//  If these individual accounts are deleted from Active Directory or the local computer they must be promptly removed from the SSO system or they could become a security risk.%r
//  SSO Affiliate Admin account: %1%r
//  Individual accounts: %2
//
#define SSO_WARN_SSO_AFF_ADMIN_NOT_GROUP 0x80002B2CL

//
// MessageId: SSO_WARN_APP_ADMIN_NOT_GROUP
//
// MessageText:
//
//  The Application Admin account contains one or more individual (not group) accounts.
//  If these individual accounts are deleted from Active Directory or the local computer they must be promptly removed from the SSO system or they could become a security risk.%r
//  Application Name: %1%r
//  Application Admin account: %2%r
//  Individual accounts: %3
//
#define SSO_WARN_APP_ADMIN_NOT_GROUP     0x80002B2DL

//
// MessageId: SSO_WARN_APP_USERS_NOT_GROUP
//
// MessageText:
//
//  The Application Users account contains one or more individual (not group) accounts.
//  If these individual accounts are deleted from Active Directory or the local computer they must be promptly removed from the SSO system or they could become a security risk.%r
//  Application Name: %1%r
//  Application Users account: %2%r
//  Individual accounts: %3
//
#define SSO_WARN_APP_USERS_NOT_GROUP     0x80002B2EL
...
// V3 - no longer returned by SSO, maintained for compatibility
//
...
// MessageText:
//
//  Could not contact the SSO server '%1'. Check that SSO is configured and that the SSO service is running on that server.
//
...
// MessageText:
//
//  For security reasons the following accounts are not allowed: Built-in accounts; Everyone;
//
#define ENTSSO_E_NO_BUILTIN_ACCOUNTS     0xC0002A19L

#define ENTSSO_E_ACCOUNT_NOT_ALLOWED ENTSSO_E_NO_BUILTIN_ACCOUNTS
//
...
// max value defined by MAX_SQL_DATABASE_NAME in ssoconstants.h
//
// MessageId: ENTSSO_E_MAX_SQL_DATABASE
//
// MessageText:
//
//  The maximum SQL database name length is 128 characters.
//
#define ENTSSO_E_MAX_SQL_DATABASE        0xC0002A55L

// max value defined by MAX_SSO_DATABASE_NAME_CREATE in ssoconstants.h
//
// MessageId: ENTSSO_E_MAX_SSO_DATABASE_CREATE
//
// MessageText:
//
//  The maximum SQL database name length that SSO can create is 123 characters, to allow for the default log file name.
//
#define ENTSSO_E_MAX_SSO_DATABASE_CREATE 0xC0002A56L

// max value defined by MAX_ENTSSO_PASSWORD in entsso_constants.idl
//
// MessageId: ENTSSO_E_MAX_PASSWORD
//
// MessageText:
//
//  The maximum password length is 256 characters.
//
#define ENTSSO_E_MAX_PASSWORD            0xC0002A57L

// max value defined by MAX_ENTSSO_REMINDER in entsso_constants.idl
//
// MessageId: ENTSSO_E_MAX_PASSWORD_REMINDER
//
// MessageText:
//
//  The maximum password reminder length is 512 characters.
//
#define ENTSSO_E_MAX_PASSWORD_REMINDER   0xC0002A58L

//
// MessageId: ENTSSO_E_MAPPINGS_ONLY_FOR_DOMAIN_ACCOUNTS
//
// MessageText:
//
//  Mappings can be created for Windows domain accounts only (not local accounts).
//
#define ENTSSO_E_MAPPINGS_ONLY_FOR_DOMAIN_ACCOUNTS 0xC0002A59L

//
// MessageId: ENTSSO_E_ACCESS_DENIED
//
// MessageText:
//
//  Access denied. See the event log (on computer '%1') for more details.
//
#define ENTSSO_E_ACCESS_DENIED           0xC0002A5AL

//
// MessageId: ENTSSO_E_NO_SECRET2
//
// MessageText:
//
//  Cannot perform encryption or decryption because the secret is not available from the master secret server. See the event log (on computer '%1') for related errors.
//
#define ENTSSO_E_NO_SECRET2              0xC0002A5BL

//
// MessageId: ENTSSO_E_MAPPING_EXISTS2
//
// MessageText:
//
//  The mapping already exists. See the event log (on computer '%1') for more details.
//
#define ENTSSO_E_MAPPING_EXISTS2         0xC0002A5CL

//
// MessageId: ENTSSO_E_DB_ACCESS2
//
// MessageText:
//
//  An error occurred while attempting to access the SSO database. See the event log (on computer '%1') for more details.
//
#define ENTSSO_E_DB_ACCESS2              0xC0002A5DL

//
// MessageId: ENTSSO_E_HOST_GROUP_ONE_ACCOUNT_ONLY
//
// MessageText:
//
//  Host Group applications cannot have multiple accounts specified for the Windows Account.
//
#define ENTSSO_E_HOST_GROUP_ONE_ACCOUNT_ONLY 0xC0002A5EL

//
// MessageId: ENTSSO_E_MAPPINGS_ONLY_FOR_DOMAIN_USER_ACCOUNTS
//
// MessageText:
//
//  For Individual applications, mappings can be created for Windows domain users only (not local accounts or group accounts).
//
#define ENTSSO_E_MAPPINGS_ONLY_FOR_DOMAIN_USER_ACCOUNTS 0xC0002A5FL
