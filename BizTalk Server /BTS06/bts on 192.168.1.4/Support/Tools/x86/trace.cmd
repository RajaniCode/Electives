...
@rem 
call %MZRT_TRACELOG_EXE%  %mqLogFileType% %mqLogFileSize% %mqStartLogger% btstrace %mqRealTime% -flags %btFlags% %mqOpenLogfile% btstrace.bin -guid #29da55e6-e688-425f-a52c-79f840cb8C89 >nul & @rem Agent
...
echo           WindowsSharepointServicesAdapter, BamTddsService
echo.
echo Examples: 
