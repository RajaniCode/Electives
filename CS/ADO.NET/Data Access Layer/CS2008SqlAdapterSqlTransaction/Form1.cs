    ...
    public partial class Form1 : Form
    {
        ...
        private DataTable SelectRecord()
        {
            ...
            try
            {
                ...
                SqlCommand commandSql = new SqlCommand(selectQuery.ToString());
        ...
        private bool Insert(string firstName, string lastName, string synonym)
        {
            ...
            try
            {
                ...
                SqlCommand commandSql = new SqlCommand(insertQuery.ToString());
                ...
                DataAccessLayer dal = new DataAccessLayer();
                int rowsAffected = dal.Insert(commandSql);
        ...
        private bool Update(int custId, string firstName, string lastName, string synonym)
        {
            ...
            try
            {
                ...
                SqlCommand commandSql = new SqlCommand(updateQuery.ToString());
                ...
                DataAccessLayer dal = new DataAccessLayer();
                int rowsAffected = dal.Update(commandSql);
        ...
        private bool Delete(int custId)
        {
            ...
            try
            {
                ...
                DataAccessLayer dal = new DataAccessLayer();
                int rowsAffected = dal.Delete(commandSql);
