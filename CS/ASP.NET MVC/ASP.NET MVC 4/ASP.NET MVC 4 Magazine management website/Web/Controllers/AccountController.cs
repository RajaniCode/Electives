namespace CIK.News.Web.Controllers
{
    ...
    using CIK.News.Web.Infras.Filters;
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(IEncrypting encryptor)
            : this(DependencyResolver.Current.GetService<IUserRepository>(), encryptor)
        {
        }

        public AccountController(IUserRepository userRepository, IEncrypting encryptor)
        {
