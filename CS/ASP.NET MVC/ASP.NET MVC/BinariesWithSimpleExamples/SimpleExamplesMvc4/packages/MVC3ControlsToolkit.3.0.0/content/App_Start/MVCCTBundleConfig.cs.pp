...
[assembly: WebActivator.PreApplicationStartMethod(
    typeof($rootnamespace$.App_Start.DMPBundleConfig), "PreStart")]
	...
	public static void PreStart() {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //    .Include("~/Scripts/MVCControlToolkit.Controls.Datetime-{version}.js") /* Add only if you use .DateTimeFor*/
                .Include("~/Scripts/globalize/MvcControlToolkit.Utils-{version}.js"));
            ...
            bundles.Add(new StyleBundle("~/Content/css_bootstrap").Include(//Bootstrap css bundle
                 ...
                 "~/Content/Site.css"));
            bundles.Add(new ScriptBundle("~/bundles/bootstrap").Include(//Bootstrap Js bundle
