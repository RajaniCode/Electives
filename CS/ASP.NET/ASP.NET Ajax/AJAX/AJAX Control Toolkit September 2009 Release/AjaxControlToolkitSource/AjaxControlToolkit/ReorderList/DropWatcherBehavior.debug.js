...
AjaxControlToolkit.DragDropList.prototype = {
    ...
    startDragDrop: function(dragObject, context, dragVisual) {
        if (!this._isDragging) {
            ...
            AjaxControlToolkit.DragDropManager.startDragDrop(this, dragVisual, context, !(Sys.Browser.agent == Sys.Browser.InternetExplorer && Sys.Browser.version > 7 && Sys.Browser.documentMode != 0));
        }
