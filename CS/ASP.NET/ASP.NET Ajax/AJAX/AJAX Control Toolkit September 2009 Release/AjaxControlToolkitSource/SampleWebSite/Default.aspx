...
To learn more, read the <a href="http://www.asp.net/learn/Ajax-Control-Toolkit/tutorial-47-cs.aspx">Getting Started Tutorial</a>, or the other walkthroughs, tutorials and videos shown on the left.
    ...
    <p>
        ...
        <strong><u>AJAX Control Toolkit Release Notes - September 2009 Release</u></strong><br />
        <strong><u>Version 3.0.30930 </u></strong></p>
    <br />
    ...
    <ul class="releaseList">
        <li><strong><a href="Seadragon/Seadragon.aspx">Seadragon</a></strong>
            <p>Seadragon enables you to pan, zoom, and make an image full screen. You can use it, for example, to display interactive product pictures.</p>
            <p>Many thanks to Microsoft Live Labs <a href="http://livelabs.com">http://livelabs.com</a> for contributing this control.</li>
        <li><strong><a href="AsyncFileUpload/AsyncFileUpload.aspx">AsyncFileUpload</a></strong>
            <p>This new control enables you to perform file uploads without doing a postback. The control displays a throbber image during upload and raises client and server events when the upload is complete.</p>
            <p>Many thanks to Steven Lindsay for building this control.</p></li>
    </ul>
    
   <p>Many thanks to by Obout <a href="http://www.obout.com">http://www.obout.com</a> for adding these controls to the AJAX Control Toolkit.</p></li>
    ...
    <br />
        ...
        <br />
        <p>
        <strong><u>Note:</u></strong> This Septemeber 2009 release: <strong>Toolkit version 3.0.30930</strong> is <em>only</em>
    ...
    <br />
      If you are using <strong>.NET Framework 2.0 and Visual Studio 2005</strong> then you should use the 
            earlier <strong>Toolkit version 1.0.20229</strong> at <a href="http://ajaxcontroltoolkit.codeplex.com/Release/ProjectReleases.aspx?ReleaseId=11121">CodePlex</a>.</p>
