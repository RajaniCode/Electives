...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function registerTests(harness)
        {
            ...
            test.addStep(function() { testHarness.assertTrue(tabPanel2._tab.className == "ajax__tab_disabled", "Panel was not hidden"); });
            test.addStep(function() { tabPanel2.set_enabled(true); });
            test.addStep(function() { testHarness.assertTrue(tabPanel2._tab.className != "ajax__tab_disabled", "Panel was not made visible"); });
            
            test = testHarness.addTest("Activate a hidden TabPanel");
            test.addStep(function() { testHarness.assertTrue(tabPanel2._tab.className == "ajax__tab_disabled", "Panel was not hidden"); });
            test.addStep(function() { tabPanel2.set_enabled(true); });
            test.addStep(function() { tabContainer1.set_activeTab(tabPanel2); });            
            test.addStep(function() { testHarness.assertTrue(tabPanel2._tab.className == "ajax__tab_active", "Panel was not made visible"); });
