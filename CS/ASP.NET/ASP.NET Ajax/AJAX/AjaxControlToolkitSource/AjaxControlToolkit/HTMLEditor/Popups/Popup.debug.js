...
AjaxControlToolkit.HTMLEditor.Popups.Popup = function(element) {
    AjaxControlToolkit.HTMLEditor.Popups.Popup.initializeBase(this, [element]);
...
AjaxControlToolkit.HTMLEditor.Popups.Popup.prototype = {
    ...
    initialize: function() {
        ...
        AjaxControlToolkit.HTMLEditor.Popups.Popup.callBaseMethod(this, "initialize");
    ...
    _app_onload: function(sender, e) {
        ...
        var element = this.get_element();
        if (AjaxControlToolkit.HTMLEditor.isReallyVisible(element)) {
...
AjaxControlToolkit.HTMLEditor.Popups.Popup.registerClass("AjaxControlToolkit.HTMLEditor.Popups.Popup", Sys.UI.Control);
