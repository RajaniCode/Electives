<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransferPage5.aspx.cs" Inherits="TransferPage5" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
  <title>The Command-Observer Pattern</title>
  <link href="stylesheets/style.css" rel="stylesheet" type="text/css" />
</head>
<body>
  <div class="heading">Build a Car using the Command-Observer Pattern</div>
