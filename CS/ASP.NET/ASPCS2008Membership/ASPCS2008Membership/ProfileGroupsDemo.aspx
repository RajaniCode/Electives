<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="ProfileGroupsDemo.aspx.cs" Inherits="ASPCS2008Membership.ProfileGroupsDemo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h3>Profile Groups and Custom Types Demo:</h3>
<style type ="text/css">
#wizard
{
