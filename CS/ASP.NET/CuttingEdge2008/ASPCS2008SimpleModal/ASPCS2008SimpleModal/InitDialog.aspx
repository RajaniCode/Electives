<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InitDialog.aspx.cs" Inherits="ASPCS2008SimpleModal.InitDialog" EnableEventValidation="false" %>
            ...
            <tr>
                <td valign="top">
                    ...
                    <asp:ObjectDataSource ID="odsCustomers" runat="server"
                        TypeName="ASPCS2008SimpleModal.CustomerManager"
