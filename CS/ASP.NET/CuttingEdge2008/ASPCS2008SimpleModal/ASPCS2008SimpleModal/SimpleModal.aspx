<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SimpleModal.aspx.cs" Inherits="ASPCS2008SimpleModal.SimpleModal" %>
    ...
    <div id="pageAbstract">
        ...
        <div id="pageContent">
            ...
            <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup" style="display:none">
                    ...
                    <asp:Button ID="Button1" runat="server" Text="Yes" width="40px" OnClientClick="yes()" />
                    <asp:Button ID="Button2" runat="server" Text="No"  width="40px" OnClientClick="no()" />
                    </div>
            </asp:Panel>
        </div>
