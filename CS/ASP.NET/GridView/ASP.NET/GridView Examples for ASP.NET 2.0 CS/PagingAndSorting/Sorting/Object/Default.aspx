...
<body>
    ...
    <div>
        <asp:ObjectDataSource ID="productDataSource" Runat="server" TypeName="ProductDAL"
            SelectMethod="GetProducts" SortParameterName="SortExpression">
        </asp:ObjectDataSource>&nbsp;<asp:GridView ID="GridView1" DataSourceID="productDataSource"
            AutoGenerateColumns="False" AllowSorting="True" BorderColor="White" BorderStyle="Ridge"
