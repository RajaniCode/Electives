...
<script runat="server">
    ...
    {
        chtMovies.DataManipulator.FilterTopN(3, "MovieCategorySeries", "MovieCategorySeries", "Y", true);
    }
</script>
...
<body>
    ...
    <div>
        <asp:Chart ID="chtMovies" runat="server" DataSourceID="srcMovies" OnDataBound="chtMovies_DataBound">
            <Series>
                <asp:Series Name="MovieCategorySeries" XValueMember="Category" YValueMembers="Count">
                </asp:Series>
            </Series>
            <ChartAreas>
        ...
        <asp:SqlDataSource ID="srcMovies" ConnectionString="<%$ ConnectionStrings:Movies %>"
            SelectCommand="CountMoviesInCategory" SelectCommandType="StoredProcedure" runat="server" />
    </div>
    </form>
</body>
</html>
