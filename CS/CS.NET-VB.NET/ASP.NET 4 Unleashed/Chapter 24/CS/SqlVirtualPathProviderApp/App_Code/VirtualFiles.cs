...
namespace AspNetUnleashed
{
    ...
    public class VirtualFiles
    {
        ...
        public static bool FileExists(string virtualPath)
        {
            ...
            string commandText = "SELECT Name FROM VirtualFiles WHERE Path=@Path AND Name=@Name";
        ...
        public static string FileContentSelect(string virtualPath)
        {
            ...
            // Initialize command
            SqlConnection con = new SqlConnection(_connectionString);
            string commandText = "SELECT Content FROM VirtualFiles WHERE Path=@Path AND Name=@Name";
            SqlCommand cmd = new SqlCommand(commandText, con);
