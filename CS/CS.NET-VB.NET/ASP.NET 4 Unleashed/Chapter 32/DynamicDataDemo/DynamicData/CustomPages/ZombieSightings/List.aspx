<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="List.aspx.cs" Inherits="DynamicDataDemo.ZombieList" %>
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource" EnablePersistedSelection="true"
                ...
                <Columns>
                    ...
                    <asp:DynamicField DataField="ZombieType" HeaderText="Zombie Type" ItemStyle-HorizontalAlign="Center"/>
                    <asp:DynamicField DataField="Description" />
                    <asp:DynamicField DataField="Feeder" HeaderText="Feeder?" ItemStyle-HorizontalAlign="Center" />
                    <asp:DynamicField DataField="Ambulatory" HeaderText="Ambulatory?" ItemStyle-HorizontalAlign="Center"/>
                </Columns>
