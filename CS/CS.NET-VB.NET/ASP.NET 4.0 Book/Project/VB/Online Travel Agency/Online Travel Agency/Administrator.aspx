<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Administrator.aspx.vb" Inherits="Online_Travel_Agency.Administrator" %>
...
<body>
    ...
    <div class="page1">
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td align="left" valign="top" bgcolor="#7C0104" class="style1">
                   <asp:Menu ID="Menu1" runat="server" Font-Size="Medium" ForeColor="White"
                            Height="35px" Font-Bold="True" Font-Italic="False" Font-Names="Times New Roman"
                ...
                <StaticHoverStyle BackColor="#7A674C" ForeColor="Black" />
                            <Items>
                                <asp:MenuItem Text="Home" Value="Home" NavigateUrl="~/Home_User.aspx">  </asp:MenuItem>
                                <asp:MenuItem Text="Car" Value="New Item" NavigateUrl="~/Car.aspx" >
                               </asp:MenuItem>
                                <asp:MenuItem Text="Bus" Value="New Item" NavigateUrl="~/Bus.aspx" >
                                   </asp:MenuItem>
                                <asp:MenuItem Text="Train" Value="New Item" NavigateUrl="~/Train.aspx"> 
                                  </asp:MenuItem>
                                <asp:MenuItem Text="Feedback" Value="New Item" NavigateUrl="~/Feedback.aspx" >
        ...
        <table>
<tr>
     <td><asp:Button ID="Btncardetails" runat="server" onclick="Btncardetails_Click" Text="Car Details" /></td>
    <td><asp:Button ID="BtnBusDetails" runat="server" Text="Bus Details"    onclick="BtnBusDetails_Click"/></td>
    <td><asp:Button ID="BtnTrainDetails" runat="server" Text="Train Details" onclick="BtnTrainDetails_Click" /></td>
   <td><asp:Button ID="btnfeedback" runat="server" Text="Feedback" /></td>
</tr>
</table>
...
<td><asp:GridView runat="server" ID="gvfeedback" AutoGenerateColumns="False" 
        ...
        onrowdeleting="gvfeedback_RowDeleting" RowHeaderColumn="Feedback" 
        BorderColor="#7C0104" BorderWidth="3px">
...
<td colspan ="4"> 
  ...
  <ControlStyle ForeColor="#4F4FFF" />
        </asp:CommandField>                                                <asp:BoundField DataField="TrainID" HeaderText="TrainID" ReadOnly ="true" />
...
</asp:Label></td><td><asp:TextBox ID="txtDepartStation" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="txtDepartStation"
                                                        
            ErrorMessage="RequiredFieldValidator" ValidationGroup="Train" ForeColor="Red">*</asp:RequiredFieldValidator></td></tr><tr><td><asp:Label ID="Label16" runat="server" Text="Arrival Station"></asp:Label></td><td><asp:TextBox ID="txtArriveStation" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="txtArriveStation"
                                                        
            ErrorMessage="RequiredFieldValidator" ValidationGroup="Train" ForeColor="Red">*</asp:RequiredFieldValidator></td></tr><tr><td><asp:Label ID="Label17" runat="server" Text="Depart Date"></asp:Label></td><td><asp:TextBox ID="txtDepartDate" runat="server"></asp:TextBox><cc1:CalendarExtender ID="txtDepartDate_CalendarExtender" runat="server" Enabled="True"
                                                        TargetControlID="txtDepartDate"></cc1:CalendarExtender>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" 
            ControlToValidate="txtDepartDate" ErrorMessage="RequiredFieldValidator" 
            ValidationGroup="Train" ForeColor="Red">*</asp:RequiredFieldValidator>
                                                    <asp:RangeValidator ID="RangeValidator2" runat="server" 
                                                        
            ControlToValidate="txtDepartDate" ValidationGroup="Train" ForeColor="Red"></asp:RangeValidator></td></tr><tr><td><asp:Label ID="Label18" runat="server" Text="Sleeper Class Seats"></asp:Label></td><td><asp:TextBox ID="txtSleeperClassSeats" runat="server"></asp:TextBox><cc1:FilteredTextBoxExtender ID="txtSleeperClassSeats_FilteredTextBoxExtender" runat="server"
                                                        Enabled="True" FilterType="Numbers" TargetControlID="txtSleeperClassSeats"></cc1:FilteredTextBoxExtender>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="txtSleeperClassSeats"
                                                        
            ErrorMessage="RequiredFieldValidator" ValidationGroup="Train" ForeColor="Red">*</asp:RequiredFieldValidator></td></tr><tr><td><asp:Label ID="Label19" runat="server" Text="AC First Class Seats"></asp:Label></td><td><asp:TextBox ID="txtACclassSeats" runat="server"></asp:TextBox><cc1:FilteredTextBoxExtender ID="txtACclassSeats_FilteredTextBoxExtender" runat="server"
                                                        Enabled="True" FilterType="Numbers" TargetControlID="txtACclassSeats"></cc1:FilteredTextBoxExtender>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="txtACclassSeats"
                                                        
            ErrorMessage="RequiredFieldValidator" ValidationGroup="Train" ForeColor="Red">*</asp:RequiredFieldValidator></td></tr><tr><td><asp:Label ID="Label20" runat="server" Text="2 Tier Seats"></asp:Label></td><td><asp:TextBox ID="txt2TierSeats" runat="server"></asp:TextBox><cc1:FilteredTextBoxExtender ID="txt2TierSeats_FilteredTextBoxExtender" runat="server"
                                                        Enabled="True" FilterType="Numbers" TargetControlID="txt2TierSeats"></cc1:FilteredTextBoxExtender>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="txt2TierSeats"
                                                        
            ErrorMessage="RequiredFieldValidator" ValidationGroup="Train" ForeColor="Red">*</asp:RequiredFieldValidator></td></tr><tr><td><asp:Label ID="Label21" runat="server" Text="3 Tier Seats"></asp:Label></td><td><asp:TextBox ID="txt3TierSeats" runat="server"></asp:TextBox><cc1:FilteredTextBoxExtender ID="txt3TierSeats_FilteredTextBoxExtender" runat="server"
                                                        Enabled="True" FilterType="Numbers" TargetControlID="txt3TierSeats"></cc1:FilteredTextBoxExtender>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ControlToValidate="txt3TierSeats"
                                                        
            ErrorMessage="RequiredFieldValidator" ValidationGroup="Train" ForeColor="Red">*</asp:RequiredFieldValidator></td></tr><tr><td><asp:Label ID="Label22" runat="server" Text="Sleeper Class Fare"></asp:Label></td><td><asp:TextBox ID="txtSleeperFare" runat="server"></asp:TextBox><cc1:FilteredTextBoxExtender ID="txtSleeperFare_FilteredTextBoxExtender" runat="server"
                                                        Enabled="True" FilterType="Custom, Numbers" TargetControlID="txtSleeperFare"
                                                        ValidChars="."></cc1:FilteredTextBoxExtender>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" ControlToValidate="txtSleeperFare"
                                                        
            ErrorMessage="RequiredFieldValidator" ValidationGroup="Train" ForeColor="Red">*</asp:RequiredFieldValidator></td></tr><tr><td><asp:Label ID="Label23" runat="server" Text="AC First Class Fare"></asp:Label></td><td><asp:TextBox ID="txtACFare" runat="server"></asp:TextBox><cc1:FilteredTextBoxExtender ID="txtACFare_FilteredTextBoxExtender" runat="server"
                                                        Enabled="True" FilterType="Custom, Numbers" TargetControlID="txtACFare" ValidChars="."></cc1:FilteredTextBoxExtender>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" ControlToValidate="txtACFare"
                                                        
            ErrorMessage="RequiredFieldValidator" ValidationGroup="Train" ForeColor="Red">*</asp:RequiredFieldValidator></td></tr><tr><td><asp:Label ID="Label24" runat="server" Text="2 Tier Fare"></asp:Label></td><td><asp:TextBox ID="txt2TierFare" runat="server"></asp:TextBox><cc1:FilteredTextBoxExtender ID="txt2TierFare_FilteredTextBoxExtender" runat="server"
                                                        Enabled="True" FilterType="Custom, Numbers" TargetControlID="txt2TierFare" ValidChars="."></cc1:FilteredTextBoxExtender>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" ControlToValidate="txt2TierFare"
            ...
            ErrorMessage="RequiredFieldValidator" ValidationGroup="Train" ForeColor="Red">*</asp:RequiredFieldValidator></td></tr><tr><td><asp:Label ID="Label25" runat="server" Text="3 Tier Fare"></asp:Label></td><td><asp:TextBox ID="txt3TierFare" runat="server"></asp:TextBox><cc1:FilteredTextBoxExtender ID="txt3TierFare_FilteredTextBoxExtender" runat="server"
                                                        Enabled="True" FilterType="Custom, Numbers" TargetControlID="txt3TierFare" ValidChars="."></cc1:FilteredTextBoxExtender>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator23" runat="server" ControlToValidate="txt3TierFare"
                                                        
            ErrorMessage="RequiredFieldValidator" ValidationGroup="Train" ForeColor="Red">*</asp:RequiredFieldValidator></td></tr><tr><td><asp:Label ID="Label26" runat="server" Text="Depart Time"></asp:Label></td><td><asp:TextBox ID="txtDepartTime" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server" ControlToValidate="txtDepartTime"
                                                        
            ErrorMessage="RequiredFieldValidator" ValidationGroup="Train" ForeColor="Red">*</asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtDepartTime"
                                                        ...
                                                        ValidationGroup="Train" 
            ForeColor="Red"></asp:RegularExpressionValidator></td></tr><tr><td>&#160;&#160;</td><td>&#160;&#160;</td></tr><tr><td>&#160;&#160;</td><td>
    <asp:Button ID="btnAddTrain" runat="server" Height="26px" OnClick="btnAddTrain_Click"
                                                        Text="Add Train Details" 
        Width="107px" ValidationGroup="Train" />
...
ValidationGroup="Bus" ForeColor="Red">*</asp:RequiredFieldValidator></td></tr><tr><td><asp:Label ID="Label9" runat="server" Text="To"></asp:Label></td><td><asp:TextBox ID="txtTo" 

runat="server"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator9" 
            runat="server" ControlToValidate="txtTo"
                                                        ErrorMessage="RequiredFieldValidator" 

ValidationGroup="Bus" ForeColor="Red">*</asp:RequiredFieldValidator></td></tr>
<tr><td><asp:Label ID="Label10" runat="server" Text="Date"></asp:Label></td>
<td><asp:TextBox ID="txtDate" runat="server"></asp:TextBox>
<cc1:CalendarExtender ID="txtDate_CalendarExtender" runat="server" Enabled="True" TargetControlID="txtDate"></cc1:CalendarExtender>
<asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
        ControlToValidate="txtDate" ErrorMessage="RequiredFieldValidator" 
        ValidationGroup="Bus" ForeColor="Red">*</asp:RequiredFieldValidator>
<asp:RangeValidator ID="RangeValidator1" runat="server" Type="Date" 
        ControlToValidate="txtDate" ErrorMessage="RangeValidator" ValidationGroup="Bus" 
        ForeColor="Red">Date is not valid</asp:RangeValidator></td></tr><tr><td><asp:Label ID="Label11" runat="server" Text="Seats Available"></asp:Label></td>
<td><asp:TextBox ID="txtSeatsAvailable" runat="server"></asp:TextBox>
<cc1:FilteredTextBoxExtender ID="txtSeatsAvailable_FilteredTextBoxExtender" runat="server" Enabled="True" FilterType="Numbers" TargetControlID="txtSeatsAvailable"></cc1:FilteredTextBoxExtender>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" 
        ControlToValidate="txtSeatsAvailable" ErrorMessage="RequiredFieldValidator" 
        ValidationGroup="Bus" ForeColor="Red">*</asp:RequiredFieldValidator></td></tr><tr><td><asp:Label ID="Label12" runat="server" Text="Fare"></asp:Label></td>
<td><asp:TextBox ID="txtFare" runat="server"></asp:TextBox>
<cc1:FilteredTextBoxExtender ID="txtFare_FilteredTextBoxExtender" runat="server"  Enabled="True" FilterType="Custom, Numbers" TargetControlID="txtFare" ValidChars=".">
</cc1:FilteredTextBoxExtender>
<asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" 
        ControlToValidate="txtFare" ErrorMessage="RequiredFieldValidator" 
        ValidationGroup="Bus" ForeColor="Red">*</asp:RequiredFieldValidator></td></tr><tr><td>&#160;&#160;</td>
<td><asp:Button ID="btnAddBusDetails" runat="server" Height="24px" 
        OnClick="btnAddBusDetails_Click"    Text="Add Bus Details" Width="105px" 
        ValidationGroup="Bus" />
...
<td><asp:TextBox ID="txtCarModel" runat="server"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
        ...
        ValidationGroup="car" ForeColor="Red">*</asp:RequiredFieldValidator></td></tr>
<tr>
<td><asp:Label ID="Label2" runat="server" Text="Full Day Rent"></asp:Label></td>
<td><asp:TextBox ID="txtFullDayRent" runat="server"></asp:TextBox><cc1:FilteredTextBoxExtender ID="txtFullDayRent_FilteredTextBoxExtender" runat="server" Enabled="True" FilterType="Custom, Numbers" TargetControlID="txtFullDayRent"  ValidChars="."></cc1:FilteredTextBoxExtender>
<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
        ControlToValidate="txtFullDayRent" ErrorMessage="RequiredFieldValidator" 
        ValidationGroup="car" ForeColor="Red">*</asp:RequiredFieldValidator></td>
</tr>
...
<cc1:FilteredTextBoxExtender ID="txtHalfDayRent_FilteredTextBoxExtender" runat="server" Enabled="True" FilterType="Custom, Numbers" TargetControlID="txtHalfDayRent" ValidChars="."></cc1:FilteredTextBoxExtender>
<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
        ControlToValidate="txtHalfDayRent" ErrorMessage="RequiredFieldValidator" 
        ValidationGroup="car" ForeColor="Red">*</asp:RequiredFieldValidator></td></tr><tr><td><asp:Label ID="Label4" runat="server" Text="Price Per Extra KM"></asp:Label></td><td><asp:TextBox ID="txtExtraKM" runat="server"></asp:TextBox>
<cc1:FilteredTextBoxExtender ID="txtExtraKM_FilteredTextBoxExtender" runat="server" Enabled="True" ValidChars="." TargetControlID="txtExtraKM" FilterType="Custom, Numbers"></cc1:FilteredTextBoxExtender>
...
<cc1:FilteredTextBoxExtender ID="txtExtraHour_FilteredTextBoxExtender" runat="server"  Enabled="True" ValidChars="." TargetControlID="txtExtraHour" FilterType="Custom, 
...
<asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
        ...
        Height="24px" Width="100px" ValidationGroup="car" /><asp:Button ID="btnReset" runat="server" Text="Reset" OnClick="btnReset_Click" 
