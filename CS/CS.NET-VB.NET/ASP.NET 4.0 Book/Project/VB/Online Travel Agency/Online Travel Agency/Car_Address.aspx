<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="Car_Address.aspx.vb" Inherits="Online_Travel_Agency.WebForm6" %>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RangeValidator ID="RangeValidator1" runat="server" 
                            ControlToValidate="txtPickupDate"></asp:RangeValidator>
                    </td>
                    <td>
                        &nbsp;
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RangeValidator ID="RangeValidator2" runat="server" 
                            ControlToValidate="dlPassengers"></asp:RangeValidator>
                    </td>
                    <td>
                        &nbsp;
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                            ControlToValidate="txtDAddress" ForeColor="Red">*</asp:RequiredFieldValidator>
                    </td>
                    <td>
                        &nbsp;
                    </td>
