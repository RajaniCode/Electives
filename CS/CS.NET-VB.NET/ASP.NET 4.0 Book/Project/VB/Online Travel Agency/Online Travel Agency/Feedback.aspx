<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="Feedback.aspx.vb" Inherits="Online_Travel_Agency.WebForm4" %>
        ...
        <tr>
            <td align="center" bgcolor="#7C0104" colspan="2" class="style4">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" 
                    Text="Give Your Feedback" Font-Size="Medium"
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="RegularExpressionValidator"
                    ...
                    ControlToValidate="txtEMail" ForeColor="Red">E-Mail Id is not valid.</asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <ContentTemplate>
                <HTMLEditor:Editor runat="server" Id="editor" Height="300px" AutoFocus="true" Width="100%" />
                 ...
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                    ErrorMessage="RequiredFieldValidator" ControlToValidate="editor" 
