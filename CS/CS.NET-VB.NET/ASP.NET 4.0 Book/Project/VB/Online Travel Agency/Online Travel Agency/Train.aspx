<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="Train.aspx.vb" Inherits="Online_Travel_Agency.WebForm2" %>
...
<table style="width: 100%">
        <tr>
            <td align="center" bgcolor="#7C0104" colspan="3" class="style7">
                <asp:Label ID="Label6" runat="server" Text="Select Train Route" Font-Bold="True" Font-Size="Medium" ForeColor="White"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" Text="From: "></asp:Label>
                <asp:DropDownList ID="dlFrom" runat="server" Height="22px" Width="107px" 
                    BackColor="#FFFFDF">
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="dlFrom"
                    ErrorMessage="RequiredFieldValidator" InitialValue="Select Station" 
                    ForeColor="Red">*</asp:RequiredFieldValidator>
            </td>
            <td>
                <asp:Label ID="Label2" runat="server" Text="To: "></asp:Label>
                <asp:DropDownList ID="dlTo" runat="server" BackColor="#FFFFDF" Height="24px">
                </asp:DropDownList>
