<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TreeViewDataBase.aspx.cs" Inherits="TreeViewDataBase" %>
...
<body>
    ...
    <asp:Label ID="Label2" runat="server" Text="TreeView Control bind to SQL Server  NORTHWIND  database" Font-Bold ="true"></asp:Label><br />
            ...
            Width="261px" ontreenodepopulate="TreeView2_TreeNodePopulate">
			<Nodes>
