...
<Assembly: EdmSchemaAttribute("6d67aac6-cef9-4682-bca0-64bc311690e9")>
#Region "EDM Relationship Metadata"
<Assembly: EdmRelationshipAttribute("northwndModel", "FK_Products_Categories", "Categories", System.Data.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, GetType(northwndModel.Category), "Products", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, GetType(northwndModel.Product), True)>
<Assembly: EdmRelationshipAttribute("northwndModel", "FK_Orders_Customers", "Customers", System.Data.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, GetType(northwndModel.Customer), "Orders", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, GetType(northwndModel.Order), True)>
<Assembly: EdmRelationshipAttribute("northwndModel", "FK_Employees_Employees", "Employees", System.Data.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, GetType(northwndModel.Employee), "Employees1", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, GetType(northwndModel.Employee), True)>
<Assembly: EdmRelationshipAttribute("northwndModel", "FK_Orders_Employees", "Employees", System.Data.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, GetType(northwndModel.Employee), "Orders", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, GetType(northwndModel.Order), True)>
<Assembly: EdmRelationshipAttribute("northwndModel", "FK_Order_Details_Orders", "Orders", System.Data.Metadata.Edm.RelationshipMultiplicity.One, GetType(northwndModel.Order), "Order_Details", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, GetType(northwndModel.Order_Detail), True)>
<Assembly: EdmRelationshipAttribute("northwndModel", "FK_Order_Details_Products", "Products", System.Data.Metadata.Edm.RelationshipMultiplicity.One, GetType(northwndModel.Product), "Order_Details", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, GetType(northwndModel.Order_Detail), True)>
<Assembly: EdmRelationshipAttribute("northwndModel", "FK_Orders_Shippers", "Shippers", System.Data.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, GetType(northwndModel.Shipper), "Orders", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, GetType(northwndModel.Order), True)>
<Assembly: EdmRelationshipAttribute("northwndModel", "FK_Products_Suppliers", "Suppliers", System.Data.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, GetType(northwndModel.Supplier), "Products", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, GetType(northwndModel.Product), True)>
<Assembly: EdmRelationshipAttribute("northwndModel", "FK_Territories_Region", "Region", System.Data.Metadata.Edm.RelationshipMultiplicity.One, GetType(northwndModel.Region), "Territories", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, GetType(northwndModel.Territory), True)>
<Assembly: EdmRelationshipAttribute("northwndModel", "CustomerCustomerDemo", "CustomerDemographics", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, GetType(northwndModel.CustomerDemographic), "Customers", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, GetType(northwndModel.Customer))>
<Assembly: EdmRelationshipAttribute("northwndModel", "EmployeeTerritories", "Employees", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, GetType(northwndModel.Employee), "Territories", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, GetType(northwndModel.Territory))>
