...
Partial Public Class MyDataClassDataContext
...
Partial Public Class Customer
    ...
    End Sub
    Private Sub OnContactNameChanging(ByVal value As String)
        If (Not Char.IsUpper(value(0))) Then
            Throw New Exception("The first letter should be in uppercase.")
        End If

        Dim minLength As Integer = 6
        If (value.Trim().Length < minLength) Then
			Throw New Exception("Name must be at least " & minLength.ToString() & "characters long.")
        End If
    End Sub
