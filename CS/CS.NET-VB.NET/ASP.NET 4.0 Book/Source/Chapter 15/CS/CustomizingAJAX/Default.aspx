...
<body>
    ...
    <asp:ScriptManager runat="server" ID="ScriptManager01">
			...
			{
				$create(CustomAJAXControl.CustomButton, {text: 'Custom Controlfunction for movement of Mouse',element: {style:{fontWeight: 
 	 			"bold", borderWidth: "2px"}}}, {click: start,drift:mousehovermovement, undrift: mouseunhovermovement},null,$get('Button1'));
			}
