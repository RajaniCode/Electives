...
<body>
   ...
   <h3> Please fill the textboxes and click the submit button to see the use of NoBot 
		...
		<ajaxToolkit:NoBot ID="NoBot1" runat="server" ResponseMinimumDelaySeconds="8" CutoffMaximumInstances="10" CutoffWindowSeconds="60" OnGenerateChallengeAndResponse="generatechallenge" />
