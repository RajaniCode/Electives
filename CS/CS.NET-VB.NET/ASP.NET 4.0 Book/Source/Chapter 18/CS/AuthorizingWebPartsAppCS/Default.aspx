...
protected void wpm_AuthorizeWebPart(object sender, 
...
<body>
    ...
    <div>
		...
		<div id="content">
			...
			<ZoneTemplate>
			<asp:HyperLink ID="HyperLink1" runat="server" Title="Allowed control"
			AuthorizationFilter="admin" NavigateUrl="~/Default.aspx">my link</asp:HyperLink>
			<asp:Label ID="Label1" runat="server" 
			Text="My label"
			Title="Allowed control"
			AuthorizationFilter="admin" />
			<asp:TextBox ID="TextBox1" runat="server" Title="restricted control:" AuthorizationFilter="admins" />
			</ZoneTemplate>
