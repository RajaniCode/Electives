...
<body>
   ...
   <div>
		...
		<div id="content">
			...
			<br />
			<asp:Button ID="Button1" runat="server" Text="Reset All" onclick="Button1_Click" />
			<br />
			<strong>
			...
			<asp:RadioButton ID="RadioButton1" runat="server" AutoPostBack="True" 
                Text="user" oncheckedchanged="RadioButton1_CheckedChanged" />
			<asp:RadioButton ID="RadioButton2" runat="server" AutoPostBack="True" 
                Text="shared" oncheckedchanged="RadioButton2_CheckedChanged" /><br />
			<asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click">Edit Mode</asp:LinkButton>&nbsp;
			&nbsp; &nbsp;<asp:LinkButton ID="LinkButton2" runat="server" 
                onclick="LinkButton2_Click">Browse</asp:LinkButton>&nbsp;
			&nbsp;
			<asp:EditorZone
