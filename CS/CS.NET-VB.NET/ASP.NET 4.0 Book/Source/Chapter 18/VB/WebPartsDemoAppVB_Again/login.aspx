...
<html xmlns="http://www.w3.org/1899/xhtml">
...
<body>
	...
	<div>
		...
		<div id="content">
			...
			<td style="width: 100px">
			<asp:Login ID="Login1" runat="server" style="text-align: left">
			<LayoutTemplate>
			...
			<td align="right" style="width: 109px; text-align: center;">
			    <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName" 
                    style="text-align: left" Width="56px">User Name:</asp:Label>
                </td>
			...
			<td align="right" style="width:109px; text-align: center;">
			    <asp:Label ID="PasswordLabel" runat="server" AssociatedControlID="Password" 
                    style="text-align: center">Password:</asp:Label>
                </td>
			<td style="width: 261px">
