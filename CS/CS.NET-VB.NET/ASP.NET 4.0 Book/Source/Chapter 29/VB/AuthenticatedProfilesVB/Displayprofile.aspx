<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Displayprofile.aspx.vb" Inherits="Displayprofile" %>
...
<body>
    ...
    <div>
    <asp:Literal ID ="Literal1" runat ="server" Text="<h1>Welcome</h1>"> </asp:Literal>
		<span><br />
        Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
