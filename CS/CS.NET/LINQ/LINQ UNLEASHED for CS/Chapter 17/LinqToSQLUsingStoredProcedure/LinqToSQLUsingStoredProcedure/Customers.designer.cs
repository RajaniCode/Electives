...
namespace LinqToSQLUsingStoredProcedure
{
    ...
    partial void DeleteCustomer(Customer instance);
		...
		public CustomersDataContext() : 
				base(global::LinqToSQLUsingStoredProcedure.Properties.Settings.Default.northwndConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		{
			string p1 = obj.CustomerID;
			this.InsertCustomer(ref p1, obj.CompanyName, obj.ContactName, obj.ContactTitle, obj.Address, obj.City, obj.Region, obj.PostalCode, obj.Country, obj.Phone, obj.Fax);
			obj.CustomerID = p1;
		}
		...
		public int InsertCustomer([Parameter(Name="CustomerID", DbType="NChar(5)")] ref string customerID, [Parameter(Name="CompanyName", DbType="NVarChar(40)")] string companyName, [Parameter(Name="ContactName", DbType="NVarChar(30)")] string contactName, [Parameter(Name="ContactTitle", DbType="NVarChar(30)")] string contactTitle, [Parameter(Name="Address", DbType="NVarChar(60)")] string address, [Parameter(Name="City", DbType="NVarChar(15)")] string city, [Parameter(Name="Region", DbType="NVarChar(15)")] string region, [Parameter(Name="PostalCode", DbType="NVarChar(10)")] string postalCode, [Parameter(Name="Country", DbType="NVarChar(15)")] string country, [Parameter(Name="Phone", DbType="NVarChar(24)")] string phone, [Parameter(Name="Fax", DbType="NVarChar(24)")] string fax)
		{
			...
			customerID = ((string)(result.GetParameterValue(0)));
			return ((int)(result.ReturnValue));
		}
		
		[Function(Name="dbo.UpdateCustomer")]
		public int UpdateCustomer([Parameter(Name="CustomerID", DbType="NChar(5)")] string customerID, [Parameter(Name="CompanyName", DbType="NVarChar(40)")] string companyName, [Parameter(Name="ContactName", DbType="NVarChar(30)")] string contactName, [Parameter(Name="ContactTitle", DbType="NVarChar(30)")] string contactTitle, [Parameter(Name="Address", DbType="NVarChar(60)")] string address, [Parameter(Name="City", DbType="NVarChar(15)")] string city, [Parameter(Name="Region", DbType="NVarChar(15)")] string region, [Parameter(Name="PostalCode", DbType="NVarChar(10)")] string postalCode, [Parameter(Name="Country", DbType="NVarChar(15)")] string country, [Parameter(Name="Phone", DbType="NVarChar(24)")] string phone, [Parameter(Name="Fax", DbType="NVarChar(24)")] string fax)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), customerID, companyName, contactName, contactTitle, address, city, region, postalCode, country, phone, fax);
			return ((int)(result.ReturnValue));
		}
