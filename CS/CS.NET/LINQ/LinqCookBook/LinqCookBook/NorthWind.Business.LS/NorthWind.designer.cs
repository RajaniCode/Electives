...
namespace NorthWind.Business.LS
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="NorthwindEF")]
    ...
    partial void InsertEmployeesTerritory(EmployeesTerritory instance);
    partial void UpdateEmployeesTerritory(EmployeesTerritory instance);
    partial void DeleteEmployeesTerritory(EmployeesTerritory instance);
    partial void InsertInternationalOrder(InternationalOrder instance);
    partial void UpdateInternationalOrder(InternationalOrder instance);
    partial void DeleteInternationalOrder(InternationalOrder instance);
    ...
    partial void InsertPreviousEmployee(PreviousEmployee instance);
    partial void UpdatePreviousEmployee(PreviousEmployee instance);
    partial void DeletePreviousEmployee(PreviousEmployee instance);
    ...
    partial void DeleteSupplier(Supplier instance);
		...
		public NorthWindDataContext() : 
				base("Data Source=.;Initial Catalog=NorthwindEF;Integrated Security=True", mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<EmployeesTerritory> EmployeesTerritories
		{
			get
			{
				return this.GetTable<EmployeesTerritory>();
			}
		}
		
		public System.Data.Linq.Table<InternationalOrder> InternationalOrders
		{
			get
			{
				return this.GetTable<InternationalOrder>();
			}
		}
		...
		public System.Data.Linq.Table<PreviousEmployee> PreviousEmployees
		{
			get
			{
				return this.GetTable<PreviousEmployee>();
			}
		}
	...
	public partial class Territory : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<EmployeesTerritory> _EmployeesTerritories;
    ...
    partial void OnRegionIDChanged();
		...
		public Territory()
		{
			this._EmployeesTerritories = new EntitySet<EmployeesTerritory>(new Action<EmployeesTerritory>(this.attach_EmployeesTerritories), new Action<EmployeesTerritory>(this.detach_EmployeesTerritories));
		...
		[Column(Storage="_TerritoryDescription", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="Territory_EmployeesTerritory", Storage="_EmployeesTerritories", ThisKey="TerritoryID", OtherKey="TerritoryID")]
		public EntitySet<EmployeesTerritory> EmployeesTerritories
		{
			get
			{
				return this._EmployeesTerritories;
			}
			set
			{
				this._EmployeesTerritories.Assign(value);
			}
		}
		...
		private void attach_EmployeesTerritories(EmployeesTerritory entity)
		{
			this.SendPropertyChanging();
			entity.Territory = this;
		}
		
		private void detach_EmployeesTerritories(EmployeesTerritory entity)
		{
			this.SendPropertyChanging();
    ...
    partial void OnPhotoPathChanged();
		...
		[Association(Name="Employee_EmployeesTerritory", Storage="_EmployeesTerritories", ThisKey="EmployeeID", OtherKey="EmployeeID")]
		public EntitySet<EmployeesTerritory> EmployeesTerritories
		{
			get
			{
	...
	[Table(Name="dbo.EmployeesTerritories")]
	public partial class EmployeesTerritory : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnTerritoryIDChanged();
		...
		[Association(Name="Employee_EmployeesTerritory", Storage="_Employee", ThisKey="EmployeeID", OtherKey="EmployeeID", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Employee.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.EmployeesTerritories.Remove(this);
					}
					this._Employee.Entity = value;
					if ((value != null))
					{
						value.EmployeesTerritories.Add(this);
		...
		[Association(Name="Territory_EmployeesTerritory", Storage="_Territory", ThisKey="TerritoryID", OtherKey="TerritoryID", IsForeignKey=true)]
	...
	[Table(Name="dbo.InternationalOrders")]
	public partial class InternationalOrder : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnExciseTaxChanged();
		...
		[Column(Storage="_CustomsDescription", DbType="NVarChar(100) NOT NULL", CanBeNull=false)]
		public string CustomsDescription
		{
			...
			set
			{
				if ((this._CustomsDescription != value))
				{
					this.OnCustomsDescriptionChanging(value);
					this.SendPropertyChanging();
					this._CustomsDescription = value;
					this.SendPropertyChanged("CustomsDescription");
					this.OnCustomsDescriptionChanged();
				}
			}
		}
		
		[Column(Storage="_ExciseTax", DbType="Money NOT NULL")]
		...
		[Association(Name="Order_InternationalOrder", Storage="_Order", ThisKey="OrderID", OtherKey="OrderID", IsForeignKey=true)]
		public Order Order
		{
			get
			{
			...
			set
			{
							...
							|| (this._Order.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.InternationalOrder = null;
					}
					this._Order.Entity = value;
					if ((value != null))
					{
						value.InternationalOrder = this;
	...
	public partial class Order : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<InternationalOrder> _InternationalOrder;
    ...
    partial void OnShipCountryChanged();
		...
		public Order()
		{
			this._InternationalOrder = default(EntityRef<InternationalOrder>);
		...
		[Association(Name="Order_InternationalOrder", Storage="_InternationalOrder", ThisKey="OrderID", OtherKey="OrderID", IsUnique=true, IsForeignKey=false)]
		public InternationalOrder InternationalOrder
		{
			get
			{
				return this._InternationalOrder.Entity;
			}
			set
			{
				InternationalOrder previousValue = this._InternationalOrder.Entity;
				if (((previousValue != value) 
							|| (this._InternationalOrder.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._InternationalOrder.Entity = null;
						previousValue.Order = null;
					}
					this._InternationalOrder.Entity = value;
					if ((value != null))
					{
						value.Order = this;
					}
	...
	[Table(Name="dbo.PreviousEmployees")]
	public partial class PreviousEmployee : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnRegionDescriptionChanged();
		...
		[Column(Storage="_RegionDescription", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
