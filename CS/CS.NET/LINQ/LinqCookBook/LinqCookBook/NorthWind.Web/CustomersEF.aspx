<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomersEF.aspx.cs" Inherits="NorthWind.Web._Default" %>
...
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="custsource" runat="server"
         ...
         SelectMethod="GetCustomersByContactTitle" TypeName="NorthWind.Business.EF.Customer">
            <SelectParameters>
