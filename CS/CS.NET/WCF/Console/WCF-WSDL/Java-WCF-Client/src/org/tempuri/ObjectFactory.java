...
public class ObjectFactory {
    ...
    private final static QName _GetDataData_QNAME = new QName("http://tempuri.org/", "data");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "data", scope = GetData.class)
    public JAXBElement<String> createGetDataData(String value) {
        return new JAXBElement<String>(_GetDataData_QNAME, String.class, GetData.class, value);
    }
