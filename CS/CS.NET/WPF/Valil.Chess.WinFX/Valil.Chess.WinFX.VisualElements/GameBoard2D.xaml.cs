...
namespace Valil.Chess.WinFX.VisualElements
{
    ...
    /// </summary>
    public partial class GameBoard2D : ContentControl
    {
        /// <summary>
        ...
        {
            // set the selections dimensions
            pieceSelection.Width = pieceSelection.Height = SquareSize;
            squareSelection.Width = squareSelection.Height = SquareSize;
        ...
        /// <summary>
        /// Sets the canvas position to this square on the board.
        /// </summary>
        ...
        private void Animate(Move move)
        {
            ...
            // bring the animated piece to the front
            // ZIndex doesn't work in partial trust because of a bug
            // Canvas.SetZIndex(visualPieces[move.From], Canvas.GetZIndex(visualPieces[move.From]) + 1);
            pieceLayer.Children.Remove(visualPieces[move.From]);
            pieceLayer.Children.Add(visualPieces[move.From]);
        ...
        private void SetOpacityAnimation(Storyboard moveStoryboard, Move move, int duration)
        {
            ...
            Storyboard.SetTargetProperty(opacityAnimation, new PropertyPath("(0)", Canvas.OpacityProperty));
        ...
        private void SetTranslationAnimation(Storyboard moveStoryboard, Move move, int duration)
        {
            ...
            Storyboard.SetTargetProperty(xAnimation, new PropertyPath("(0).(1)", Canvas.RenderTransformProperty, TranslateTransform.XProperty));
            xAnimation.Freeze();
            ...
            Storyboard.SetTargetProperty(yAnimation, new PropertyPath("(0).(1)", Canvas.RenderTransformProperty, TranslateTransform.YProperty));
            yAnimation.Freeze();
