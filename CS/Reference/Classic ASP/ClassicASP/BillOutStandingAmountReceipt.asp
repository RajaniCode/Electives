...
'-----------------------------------------------------------------------------
' BillOutStandingAmounReceipt.asp

' Submits a credit card transaction to PayPal using a
' BillOutStandingAmount request.

' The code collects transaction parameters from the form
' displayed by BillOutStandingAmoun.asp then constructs and sends
' the BillOutStandingAmoun request string to the PayPal server.
...
' Called by BillOutStandingAmounR.asp
...
'-----------------------------------------------------------------------------
	Set resArray	= hash_call("BillOutstandingAmount",nvpstr)
...
<html>
	<head>
		<title>PayPal ASP SDK - BillOutStandingAmount API</title>
	...
	SESSION("ErrorMessage")	= ErrorFormatter(Err.Description,Err.Number,Err.Source,"BillOutStandingAmountReceipt.asp")
