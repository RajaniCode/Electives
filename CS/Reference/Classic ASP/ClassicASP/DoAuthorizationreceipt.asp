...
'-----------------------------------------------------------------------------
	...
	nvpstr	=	"&TRANSACTIONID=" &authorization_id & _
				"&AMT="&amount &_
...
'-----------------------------------------------------------------------------
	Set resArray	= hash_call("DOAuthorization",nvpstr)
...
<html>
<head>
<title>PayPal ASP SDK - DoAuthorization API</title>
...
<body alink=#0000FF vlink=#0000FF>
	...
	SESSION("ErrorMessage")	= ErrorFormatter(Err.Description,Err.Number,Err.Source,"authorizationreceipt.asp")
	Response.Redirect "APIError.asp"
	Else
