...
'-----------------------------------------------------------------------------
' GetRecurringPaymentsProfileDetailsReceipt.asp

' Submits a credit card transaction to PayPal using a
' GetRecurringPaymentsProfileDetails request.

' The code collects transaction parameters from the form
' displayed by GetRecurringPaymentsProfileDetails.asp then constructs and sends
' the GetRecurringPaymentsProfileDetails request string to the PayPal server.
...
' Called by GetRecurringPaymentsProfileDetails.asp.
...
<html>
	<head>
		<title>PayPal ASP SDK - GetRecurringPaymentsProfile API</title>
	...
	SESSION("ErrorMessage")	= ErrorFormatter(Err.Description,Err.Number,Err.Source,"GetRecurringPaymentsProfileDetailsReceipt.asp")
